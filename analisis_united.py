...
def analizar_estabilidad(df):
    ...
    if 'Estable (1 Técnico)' in comparativa.index and 'Transición (Relevo)' in comparativa.index:
...
def graficar_eficiencia_y_brecha(df):
    ...
    plt.close()
    print("✅ Gráfico guardado como 'assets/figures/eficiencia_y_brecha.png'")
